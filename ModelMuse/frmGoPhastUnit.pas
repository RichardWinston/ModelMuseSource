...
uses
  ...
  frmGeoRefUnit, GeoRefWriterUnit;
...
//  StrMT3DMS = 'MT3DMS';
  ...
  'o work with the double-precision version of MODFLOW, you nee';
...
begin
  ...
  try
    ...
    begin
      TFile.Copy(IniFile.FileName, BackUpFileName);
    end;
...
{$IFNDEF MF2015}
  acModflow6Active.Visible := False;
  acRunModflow6.Visible := False;
{$ENDIF}
...
{$ENDIF}
  ...
  acShowTopMesh.Visible := PhastModel.ModelSelection  in SutraSelection;
  acShowFrontMesh.Visible := PhastModel.ModelSelection  in SutraSelection;
  ...
  tlb3dViewMesh.Visible := PhastModel.ModelSelection  in SutraSelection;
...
var
  ...
  Fraction: double;
begin
  if not (ModelSelection  in SutraSelection) then
  begin
    Exit;
  end;
  ...
  begin
    ...
    begin
      ...
      UndoStack.Submit(TUndoGeneralOptions.Create(NewModelOptionsCollection,
        PhastModel.ModflowPackages.Mt3dBasic.MassUnit));
    end;
...
initialization
  ...
  MfNwtDate := EncodeDate(2016,7,28);
