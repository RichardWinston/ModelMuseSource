...
resourcestring
  ...
  StrTheFollowingObject = 'The following objects defines a transient %s. SUT' +
  'RA will not use the transient data.';
...
begin
  ...
  RootError := Format(StrTheFollowingObject, [BoundaryIdentifier]);
