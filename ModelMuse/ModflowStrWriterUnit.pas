...
//  'ress Period: %4:d';
  ...
  StrTheFollowingObjectBadTribs = 'The following objects define segments in ' +
  'the STR package that have tributaries with no reaches.';
      ...
      begin
        ...
        begin
          frmErrorsAndWarnings.AddError(Model, StrTheFollowingObjectBadTribs,
            ASegment.ScreenObject.Name,ASegment.ScreenObject);
        end;
      end;
    end;
  end;
