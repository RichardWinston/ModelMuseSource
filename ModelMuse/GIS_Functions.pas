...
begin
  ...
  begin
    ...
    try
      ...
      begin
        GlobalCurrentScreenObject.GetCellsToAssign(LocalModel.Mesh, '0', nil, nil,
          CellList, alAll, GlobalCurrentModel);
      end;
...
function GetVertexIndiciesInCurrentCell(var FirstVertex, LastVertex: Integer;
  const CallingFunctionName: string): Boolean;
var
  SegmentPosition: Integer;
  Segments: TCellElementSegmentList;
  StartIndex: Integer;
...
begin
  ...
  begin
    LocalGrid := (GlobalCurrentModel as TCustomModel).Grid;
    LocalMesh := (GlobalCurrentModel as TCustomModel).Mesh;
...
begin
  ...
  if (DataArray <> nil) and (Packages.ChdBoundary.IsSelected or Packages.FhbPackage.IsSelected) then
  begin
...
initialization
  ...
  ObjectBasisFunction_Function.Prototype := StrObject+''
  ...
  LowestVertexValuesFunction.Prototype := StrObject+''
  ...
  HighestVertexValuesFunction.Prototype := StrObject+''
  ...
  MeanVertexValuesFunction.Prototype := StrObject+''
  ...
  MedianVertexValuesFunction.Prototype := StrObject+''
  ...
  FirstVertexValuesFunction.Prototype := StrObject+''
  ...
  LastVertexValuesFunction.Prototype := StrObject+''
