...
//  StrWritingDataSet8 = '  Writing Data Set 8.';
  ...
  StrTheOptionIsOnly = 'The % option is only supported in MODFLOW-NWT versio' +
  'n 1.1 or later.';
    ...
    case NwtFormat of
      ...
      nf1_1:
        begin
          ...
          if UzfPackage.SpecifySurfaceK then
          begin
          ...
          begin
            ...
            WriteToNameFile(StrDATABINARY, unitrech,
              ChangeFileExt(FNameOfFile, '.UzfRch'), foOutput, Model);
            WriteToNameFile(StrDATABINARY, unitdis,
              ChangeFileExt(FNameOfFile, '.UzfDisch'), foOutput, Model);
          end;
