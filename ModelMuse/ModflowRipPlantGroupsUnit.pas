...
procedure GlobalRemoveRipSubscription(Sender: TObject; Subject: TObject;
  const AName: string);
procedure GlobalRestoreRipSubscription(Sender: TObject; Subject: TObject;
  const AName: string);
...
//  AssignObserverEvents(Collection);
  ...
  OnRemoveSubscription := GlobalRemoveRipSubscription;
  OnRestoreSubscription := GlobalRestoreRipSubscription;
end;
...
begin
  ...
  result.AddSubscriptionEvents(
    GlobalRemoveRipSubscription,
    GlobalRestoreRipSubscription, self);
end;
...
begin
  ...
  FormulaManager.Remove(FSaturatedExtinctionDepth, GlobalRemoveRipSubscription,
    GlobalRestoreRipSubscription, self);
  FormulaManager.Remove(FActiveRootDepth, GlobalRemoveRipSubscription,
    GlobalRestoreRipSubscription, self);
  FormulaManager.Remove(FMaxET, GlobalRemoveRipSubscription,
    GlobalRestoreRipSubscription, self);
  FormulaManager.Remove(FSatExtinctionEvap, GlobalRemoveRipSubscription,
    GlobalRestoreRipSubscription, self);
end;
